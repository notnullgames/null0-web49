...
static web49_interp_data_t web49_api_runtime_CheckCollisionPointPoly(web49_interp_t interp) {
  web49_interp_data_t ret;
  ret.i32_s = (int32_t)CheckCollisionPointPoly(
      *(Vector2*)&interp.memory[interp.locals[0].i32_u],
      (Vector2*)&interp.memory[interp.locals[1].i32_u],
      (int)interp.locals[2].i32_s);
  return ret;
...
static web49_interp_data_t web49_api_runtime_GenImagePerlinNoise(web49_interp_t interp) {
  web49_interp_data_t ret;
  *(Image*)&interp.memory[interp.locals[0].i32_u] = GenImagePerlinNoise(
      (int)interp.locals[0].i32_s,
      (int)interp.locals[1].i32_s,
      (int)interp.locals[2].i32_s,
      (int)interp.locals[3].i32_s,
...
static web49_interp_data_t web49_api_runtime_ImageDrawCircleLines(web49_interp_t interp) {
  web49_interp_data_t ret;
...
static web49_interp_data_t web49_api_runtime_ImageDrawCircleLinesV(web49_interp_t interp) {
  web49_interp_data_t ret;
...
// returns ptr: LoadUTF8
static web49_interp_data_t web49_api_runtime_UnloadUTF8(web49_interp_t interp) {
  web49_interp_data_t ret;
  UnloadUTF8(
      (char*)&interp.memory[interp.locals[0].i32_u]);
  return ret;
...
static web49_interp_data_t web49_api_runtime_GetCodepointNext(web49_interp_t interp) {
  web49_interp_data_t ret;
  ret.i32_s = (int32_t)GetCodepointNext(
      (const char*)&interp.memory[interp.locals[0].i32_u],
      (int*)&interp.memory[interp.locals[1].i32_u]);
  return ret;
}
static web49_interp_data_t web49_api_runtime_GetCodepointPrevious(web49_interp_t interp) {
  web49_interp_data_t ret;
  ret.i32_s = (int32_t)GetCodepointPrevious(
      (const char*)&interp.memory[interp.locals[0].i32_u],
      (int*)&interp.memory[interp.locals[1].i32_u]);
  return ret;
}
...
web49_env_func_t web49_api_import_raylib(const char* name) {
  ...
  if (!strcmp(name, "CheckCollisionPointPoly")) {
    return &web49_api_runtime_CheckCollisionPointPoly;
  }
  ...
  if (!strcmp(name, "GenImagePerlinNoise")) {
    return &web49_api_runtime_GenImagePerlinNoise;
  }
  ...
  if (!strcmp(name, "ImageDrawCircleLines")) {
    return &web49_api_runtime_ImageDrawCircleLines;
  }
  if (!strcmp(name, "ImageDrawCircleLinesV")) {
    return &web49_api_runtime_ImageDrawCircleLinesV;
  }
  ...
  */
  ...
  if (!strcmp(name, "UnloadUTF8")) {
    return &web49_api_runtime_UnloadUTF8;
  }
  ...
  if (!strcmp(name, "GetCodepointNext")) {
    return &web49_api_runtime_GetCodepointNext;
  }
  if (!strcmp(name, "GetCodepointPrevious")) {
    return &web49_api_runtime_GetCodepointPrevious;
  }
